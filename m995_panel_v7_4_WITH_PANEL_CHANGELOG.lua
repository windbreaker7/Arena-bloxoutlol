    ...
    Callback = function()
        ...
        task.spawn(function()
            pcall(function()
                ...
                local response = game:HttpGet("https://raw.githubusercontent.com/YOUR_USERNAME/YOUR_REPO/main/Update.md", true)
                if response then
...
DecompilerTab:CreateButton({
    ...
    Callback = function()
        ...
        task.spawn(function()
            pcall(function()
                local response = game:HttpGet("https://raw.githubusercontent.com/windbreaker7/MEGGD-Script-Scanner/refs/heads/main/Update.md", true)
                if response then
